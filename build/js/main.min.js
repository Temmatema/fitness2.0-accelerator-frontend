...
var COACHES = [{
  name: 'Анна Павлова',
  url: 'img/main/coaches/anna.jpg'
}, {
  name: 'Алексей Лавров',
  url: 'img/main/coaches/aleksey.jpg'
}, {
  name: 'Александр Пашков',
  url: 'img/main/coaches/aleksandr.jpg'
}, {
  name: 'Мария Кетова',
  url: 'img/main/coaches/mariya.jpg'
}, {
  name: 'Анна Павлова',
  url: 'img/main/coaches/anna.jpg'
}, {
...
require("./modules/season-tickets.js");
require("./modules/create-coaches.js");
require("./modules/swiper-coaches.js");
require("./modules/swiper-reviews.js");
var _accordions = require("./utils/accordions.js");
var _tabs = require("./utils/tabs.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('load', function () {
    var accordion = new _accordions.Accordions();
...
},{"./modules/create-coaches.js":3,"./modules/form-validate/form":5,"./modules/modals/init-modals":11,"./modules/scroll.js":13,"./modules/season-tickets.js":14,"./modules/swiper-coaches.js":15,"./modules/swiper-reviews.js":16,"./modules/video-handle.js":17,"./utils/accordions.js":18,"./utils/ios-vh-fix":21,"./utils/tabs.js":23}],3:[function(require,module,exports){
"use strict";

var _coachesMock = require("../coaches-mock.js");
var coachCard = document.querySelector('#coach').content.querySelector('.coaches__card');
var parentBlock = document.querySelector('.swiper-wrapper');
_coachesMock.COACHES.forEach(function (coach) {
  var cardClone = coachCard.cloneNode(true);
...
},{"../coaches-mock.js":1}],4:[function(require,module,exports){
"use strict";
...
headerBtn.onclick = function () {
  return scrollToElement('tickets');
};
...
var ACTIVE_CLASS = 'tickets-button--active';
var prices = [5000, 1700, 2700];
buttons.forEach(function (btn, index) {
  return btn.addEventListener('click', function () {
    return swapCards(btn, index);
  });
});
function swapCards(btn, index) {
  swapClass(btn);
  cardsPrice.forEach(function (el, id) {
    switch (index) {
      case 0:
        {
          el.childNodes[0].nodeValue = " ".concat(prices[id], " ");
          el.dataset.price = "".concat(prices[id]);
          break;
        }
      case 1:
        {
          el.childNodes[0].nodeValue = " ".concat(prices[id] * 3, " ");
          el.dataset.price = "".concat(prices[id] * 3);
          break;
        }
      case 2:
        {
          el.childNodes[0].nodeValue = " ".concat(prices[id] * 5, " ");
          el.dataset.price = "".concat(prices[id] * 5);
          break;
        }
      default:
        return el;
...
var videoBlock = document.querySelector('.workout__video');
